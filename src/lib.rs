...
#[derive(Debug)]
pub struct RenderNetProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RenderNetProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RenderNet processing");
    
    let mut processor = RenderNetProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RenderNetProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RenderNetProcessor::new(false);
